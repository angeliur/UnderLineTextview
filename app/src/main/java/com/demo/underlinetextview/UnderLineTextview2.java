...
//如果Textview换行的话，只有最后一行的下面才会有下划线
public class UnderLineTextview2 extends TextView {
    ...
    public UnderLineTextview2(Context context, AttributeSet attrs) {
    ...
    public UnderLineTextview2(Context context, AttributeSet attrs, int defStyle) {
